...
| **Storage** | FAT32 (HDD/USB) + ISO 9660 (CD-ROM) over IDE PIO. Disk filesystems live under `/mnt`: FAT32 auto-mounts at `/mnt/hd`, CD-ROM at `/mnt/cdrom`. `mount /dev/hdaN /mnt/<name>` for arbitrary mountpoints. Read + write + delete + rename on FAT32; flush + unmount on shutdown/reboot. |
