...
- [x] **T59 — editing-keys + tray/widget polish (2nd test-feedback batch).**
  ...
  - **Not done (noted):** linx Alt-to-open-menu (Alt+letter isn't delivered to apps — needs kernel Alt-combo support; menu opens via F9/m); HTML form text input *in linx* (mxweb has it).
