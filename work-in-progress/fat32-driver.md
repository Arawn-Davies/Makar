...
FAT32 filesystem driver mounted at `/mnt/hd` from the first FAT32 partition
detected on any ATA drive.  ISO 9660 is also supported, mounted at `/mnt/cdrom`.
...
- [x] Auto-mount on boot: `vfs_auto_mount()` scans all ATA drives, mounts
      first FAT32 partition at `/mnt/hd`; ISO 9660 mounted at `/mnt/cdrom`
